...
type MainServiceClient interface {
	Send(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserReply, error)
}
...
func (c *mainServiceClient) Send(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
	err := c.cc.Invoke(ctx, "/gen.MainService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MainServiceServer interface {
	Send(context.Context, *UserRequest) (*UserReply, error)
...
func (UnimplementedMainServiceServer) Send(context.Context, *UserRequest) (*UserReply, error) {
...
func _MainService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MainServiceServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gen.MainService/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MainServiceServer).Send(ctx, req.(*UserRequest))
	}
...
var MainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gen.MainService",
	HandlerType: (*MainServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Send",
			Handler:    _MainService_Send_Handler,
		},
	},
